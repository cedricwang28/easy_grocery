...
class EasyGroceries {
    ...
    // get two random characters to work as the salt
    public function createSalt () {
        ...
        // return two randomized characters
        return $sid;  
    }
    ...
    public function encryptPassword ($password, $salt) {
        ...
        for ($x=1;$x<=10;++$x) {
            // md5 is one method of doing hash component, generate a 32-character string 
    ...
    // generate a cart page on the fly
    ...
    // send out password, account information to banking system 
    public function makePayment () {
        
        // sent to bank for verification and transaction code
        // simulte the transaction code coming back from the bank 
        srand(time());				
    ...
    public function makeInvoice ($transaction_code, $myCart, $ea_user_id, $billing_name_last, $billing_name_first) {
        ...
        if (!empty($transaction_code)) {
            ...
            try {
                ...
                // send email, something for next week, sending email will only work on your own personal server
